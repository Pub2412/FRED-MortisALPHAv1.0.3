 ...
 */
public class LEVEL5_HALLWAY_CH2 extends Room
{
...
private void prepare()
{
    ...
    QuestionText question = new QuestionText("To Whom are you going to throw?");
    addObject(question, 8, 3); // x, y position (centered near top)

    // Add choice buttons for player decision
    ChoiceButton option1 = new ChoiceButton("Daisy", () -> {
        Greenfoot.setWorld(new CUTSCENE_DOCTOR_ENDING());
    });
    ChoiceButton option2 = new ChoiceButton("The Doctor", () -> {
        Greenfoot.setWorld(new CUTSCENE_DAISY_ENDING());
    });
    
        ChoiceButton option3 = new ChoiceButton("Throw away your shot", () -> {
        Greenfoot.setWorld(new CUTSCENE_FAITH_ENDING());
    });
    ...
    addObject(option2, 11, 4);
       ...
       if (WorldController.isPuzzleSolved("CH")) addObject(option3, 8, 4);
   }

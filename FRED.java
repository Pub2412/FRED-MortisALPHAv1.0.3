...
public class FRED extends Actor {
    ...
    private int moveDelay = 80; // Number of frames to wait between moves
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            stopAllSounds();
            Greenfoot.setWorld(new FRED_JUMPSCARE());
            return;
        }
        ...
        if (cooldownFrames > 0) {
            ...
            startProximityMusic(); // Start music (after taunt triggers)
            cooldownFrames = COOLDOWN_TIME;
        }
    }

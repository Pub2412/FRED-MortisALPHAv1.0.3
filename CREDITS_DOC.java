 ...
 */
public class CREDITS_DOC extends World
{
   ...
   private GreenfootImage[] cutsceneImages;
    ...
    public CREDITS_DOC() {
        super(16, 12, 80);
        cutsceneMusic = new GreenfootSound("doc/Doc_Credits.wav"); // or .wav, use correct file extension
    ...
    public void act() {
        ...
        if (delayCount >= frameDelay) {
            ...
            if (currentFrame < cutsceneImages.length) {
                ...
                stopCutsceneMusic();
                Greenfoot.setWorld(new End_Doc());
            }
        }
    }

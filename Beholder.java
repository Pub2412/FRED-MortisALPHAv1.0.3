 ...
 */
public class Beholder extends Actor {
    ...
    public static int moveDelay = 100; // Number of frames to wait between moves
    ...
    if (isTouching(Player.class)) {
        stopAllSounds();
        Greenfoot.setWorld(new BEHOLDER_JUMPSCARE());
        return;
    }

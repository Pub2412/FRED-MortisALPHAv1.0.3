 ...
 */
public class CREDITS_FAITH extends World
{
   ...
   private GreenfootImage[] cutsceneImages;
    ...
    public CREDITS_FAITH() {
        super(16, 12, 80);
        cutsceneMusic = new GreenfootSound("faith/Faith_Credits.wav"); // or .wav, use correct file extension
    ...
    public void act() {
        ...
        if (delayCount >= frameDelay) {
            ...
            if (currentFrame < cutsceneImages.length) {
                ...
                stopCutsceneMusic();
                Greenfoot.setWorld(new End_Faith());
            }
        }
    }

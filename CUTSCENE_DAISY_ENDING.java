...
/**
 * Write a description of class CUTSCENE_DAISY_ENDING here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CUTSCENE_DAISY_ENDING extends World
{
    int currentProgress = 0;
    int progressDelay = 0;
    int pressCooldown = 0;
    private GreenfootSound cutSnd = new GreenfootSound("cutscenes/int_1.wav");
    public CUTSCENE_DAISY_ENDING()
    {    
    ...
    private void handleCutscene() {
        ...
        switch (currentProgress) {
            case 1:
                ...
                WorldController.showMessage("*HOLY WATER THROWN TO THE DOCTOR*");
                cutSnd = new GreenfootSound("sfx/shatter.wav");
                cutSnd.play();
                break;
            case 2:
                cutSnd.stop();
                WorldController.showMessage("HAHA YOU FOOL");
                cutSnd = new GreenfootSound("daisy/int_1.wav");
                cutSnd.play();
                break;
            case 3:
                MusicPlayer.StopMus();
                setBackground("lostsoulintro/Screen Recording 2025-11-14 131805_170.png");
                WorldController.showMessage("I AM IN CONTROL, IT HAS NO EFFECT");
                cutSnd = new GreenfootSound("daisy/int_2.wav");
                cutSnd.play();
                break;
            case 4:
                cutSnd.stop();
                WorldController.showMessage("I SHALL KILL YOU NOW");
                cutSnd = new GreenfootSound("daisy/int_3.wav");
                cutSnd.play();
                break;
            case 5:
                cutSnd.stop();
            ...
            case 6:
                cutSnd.stop();
                MusicPlayer.StopMus();
                WorldController.changeRoomNoTransition("CREDITS_DAISY");
                break;
        }
        currentProgress++;
        progressDelay = 120;

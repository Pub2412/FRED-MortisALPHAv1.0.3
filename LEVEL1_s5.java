...
/**
 * LEVEL1_s5 - Room with no WASD message, player enters from left, exit on top
 */
public class LEVEL1_s5 extends LEVEL1
{
    ...
    public LEVEL1_s5(){
        super();
        setSongFile("silence");
        // Connections: left from LEVEL1, top" to LEVEL1_s5 (example next room), others null or LEVEL1 if cycling
        setConnections("LEVEL1_s6", "LEVEL1_s6", "LEVEL1_s6", "LEVEL1_s6");
        prepare();
    }

 ...
 */
public class CREDITS_DAISY extends World
{
   ...
   private GreenfootImage[] cutsceneImages;
    ...
    public CREDITS_DAISY() {
        super(16, 12, 80);
        cutsceneMusic = new GreenfootSound("daisy/Daisy_Credits.wav"); // or .wav, use correct file extension
    ...
    public void act() {
        ...
        if (delayCount >= frameDelay) {
            ...
            if (currentFrame < cutsceneImages.length) {
                ...
                stopCutsceneMusic();
                Greenfoot.setWorld(new End_Daisy());
            }
        }
    }

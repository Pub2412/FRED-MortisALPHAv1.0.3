 ...
 */
public class LEVEL4_PUZZLE_GAME4 extends LEVEL4_PUZZLE_GAME
{
    PlayerLevel4Puzzle player = new PlayerLevel4Puzzle(2);
    TargetLevel4Puzzle target = new TargetLevel4Puzzle("LEVEL4_PUZZLE4", "LEVEL4_PUZZLE4");
    public LEVEL4_PUZZLE_GAME4()
    {
        prepare();
    }
    private void prepare()
    {
        addObject(new Solid("box_dark.png"),10,8);
        addObject(new Solid("box_dark.png"),12,8);
        addObject(new Solid("box_dark.png"),14,8);
        addObject(new Solid("box_dark.png"),18,10);
        addObject(new Solid("box_dark.png"),10,12);
        addObject(new Solid("box_dark.png"),12,12);
        addObject(new Solid("box_dark.png"),14,12);
        addObject(new Solid("box_dark.png"),10,14);
        addObject(new Solid("box_dark.png"),12,14);
        addObject(new Solid("box_dark.png"),14,14);
        addObject(new Solid("box_dark.png"),18,14);
        
        addObject(new Solid("room/edge_d.png"),10,16);
        ...
        addObject(new Solid("room/edge_u.png"),10,6);
        ...
        addObject(new Solid("room/edge_l.png"),8,8);
        addObject(new Solid("room/edge_l.png"),8,10);
        addObject(new Solid("room/edge_l.png"),8,12);
        addObject(new Solid("room/edge_l.png"),8,14);
